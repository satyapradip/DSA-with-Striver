...
1. Implement a STACK using TWO QUEUES (LeetCode 225)
2. Implement a QUEUE using TWO STACKS (LeetCode 232)

KEY INSIGHT: Using FIFO + FIFO we can achieve LIFO!
             Using LIFO + LIFO we can achieve FIFO!
"""
...
# ==============================================================================
# 1️⃣  STACK USING TWO QUEUES  (LeetCode 225) ⭐⭐
# ==============================================================================
# The trick: On push, ROTATE all old elements behind the new one so the
# newest element sits at the FRONT of the queue.
#
# Visual:
#   Queue: [1, 2]  → push(3):
#   1. Add 3 to q2:        q2 = [3]
#   2. Move 1, 2 after 3:  q2 = [3, 1, 2]
#   3. Swap q1 ↔ q2:       q1 = [3, 1, 2]
#
#   Now the FRONT of q1 = 3 = TOP of the stack! (most recent pushed)
#
# Time Complexity:
#   push: O(n) - must rotate all old elements
#   pop:  O(1)
# ==============================================================================
...
class StackUsingQueues:
    ...
    def push(self, item):
        ...
        Time Complexity: O(n) - rotate all old elements behind new one
        """
        # Add new item to q2
        self.q2.append(item)
        print(f"  📥 {item} added to q2 → {list(self.q2)}")

        # Move ALL elements from q1 to q2 (behind the new item)
        while self.q1:
            moved = self.q1.popleft()
            self.q2.append(moved)
    ...
    def is_empty(self):
        return not self.q1
# ==============================================================================
# 2️⃣  QUEUE USING TWO STACKS  (LeetCode 232) ⭐⭐
# ==============================================================================
# Similarly, we can use two stacks to simulate FIFO behavior.
#
# Visual:
#   Stack 1 (input):  [3, 2, 1]  ← push new elements here (1 on top)
#   Stack 2 (output): []         ← pop from here
#
#   When output is empty, transfer ALL from input to output:
#   Stack 1: []
#   Stack 2: [1, 2, 3]  (3 on top → first element in = first out!)
#
# Time Complexity:
#   enqueue: O(1)
...
if __name__ == "__main__":
    ...
    print("\n" + "█" * 60)
    print("██  STACK ↔ QUEUE CONVERSIONS")
    print("█" * 60)

    print("\n" + "=" * 60)
    print("📖 SECTION 1: STACK USING TWO QUEUES")
    print("=" * 60)
    print()
    print("   🧠 MENTAL MODEL:")
    ...
    print("\n" + "=" * 60)
    print("📖 SECTION 2: QUEUE USING TWO STACKS")
    print("=" * 60)
    print()
    print("   🧠 MENTAL MODEL:")
    ...
    print("=" * 60)
    print()
    print("   Each element is moved at most TWICE:")
    print("   1. input → output (during transfer)")
    print("   2. output → popped (during dequeue)")
    print()
    print("   Average = O(1) per operation → 'Amortized O(1)'!")

    print("\n🚀 NEXT: Run 05_monotonic_stack.py to learn the interview gold!")
    print("   (Next Greater Element + Stock Span - MONOTONIC STACK!)")